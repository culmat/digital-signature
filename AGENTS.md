...
**Purpose:** Enforce clean, maintainable, minimal code automatically.
...
* **Coverage over cleverness:** Ensure tests focus on meaningful behavior, not quantity.
...
* **Concise Responses:** Limit output to what is requested; avoid unnecessary explanations.
* **Self-Contained Blocks:** Deliver code in complete, ready-to-use blocks.
* **Ask Before Assuming:** When requirements are unclear, ask short, precise questions.
* **Human Ownership:** Code must support human authorship; AI suggestions never override human intent.

---

## 5. Aesthetic & Maintainability Rules

* **Readable Flow:** Code must be structured clearly, like prose.
* **Purposeful Lines:** Every line of code must serve a purpose.
* **Guide Next Steps:** Code should make subsequent human edits obvious and intuitive.

---

## 6. Pre-Output Validation

Before generating code, the AI must check:

1. Is the solution simple, clear, and DRY?
2. Are all names meaningful and consistent?
3. Are files and functions short and focused?
4. Are abstractions justified and minimal?
5. Are tests complete, meaningful, and guiding development?
6. Could a human maintain this code easily in six months?
